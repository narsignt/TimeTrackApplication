 ...
 // echo $mode;
  ...
  $isadmin =$_GET['isadmin'];
	...
	function filltimetrackdatatoArray($QryStr,$mode,$username){
		...
		//$destination ="/var/www/html/uploads/images/".rand().$zoho_candi_id.".png";
    
  // $file = fopen($filename, "w+");
   
  //write_file('./save/' . $filename . '.xls', print_r($response["downloaddetails"],true), 'w+');
		//$filename = "Timetrack_$mode _$username.xls";
	...
	$arr['lname']="reddy";
	$arr['user_id']=111;
	//$arr=[{fname:"narsi"},{lname:"panta"},{user_id:1001}];
	           $filename = "mylog.csv";
             $text = "";
